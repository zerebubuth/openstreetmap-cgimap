...
public:
	...
	bbox_t() :
		minlat(200 * Options::get_instance().get_bbox_scale()),
		minlon(200 * Options::get_instance().get_bbox_scale()),
		maxlat(-200 * Options::get_instance().get_bbox_scale()),
		maxlon(-200 * Options::get_instance().get_bbox_scale()) {};

	bbox_t(double _minlat, double _minlon, double _maxlat, double _maxlon) :
		minlat(_minlat * Options::get_instance().get_bbox_scale()),
		minlon(_minlon * Options::get_instance().get_bbox_scale()),
		maxlat(_maxlat * Options::get_instance().get_bbox_scale()),
		maxlon(_maxlon * Options::get_instance().get_bbox_scale()) {};
