...
class OSMChangeJSONParserFormat {
  ...
  static auto getMainParser(ElementParserCallback element_parser_callback = nullptr) {
    return Parser{
       Object{
        std::tuple{
          Member{"version", Value<std::string>{}},
...
private:
  ...
  MainParser _parser{api06::OSMChangeJSONParserFormat::getMainParser(std::bind_front(&api06::OSMChangeJSONParser::process_element, this))};
