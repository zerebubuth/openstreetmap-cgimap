...
relation_history_responder::relation_history_responder(mime::type mt, osm_nwr_id_t id_, factory_ptr &w_)
...
responder_ptr_t relation_history_handler::responder(factory_ptr &w) const {
