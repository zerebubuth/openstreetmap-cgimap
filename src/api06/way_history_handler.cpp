...
way_history_responder::way_history_responder(mime::type mt, osm_nwr_id_t id_, factory_ptr &w_)
...
responder_ptr_t way_history_handler::responder(factory_ptr &w) const {
